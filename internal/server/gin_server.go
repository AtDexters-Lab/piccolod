...
func (s *GinServer) setupGinRoutes() {
	...
	v1 := r.Group("/api/v1")
	{
		...
		apps := authed.Group("/apps")
		{
			...
			apps.GET("/:name/config", s.requireAdmin(), s.handleGinAppConfigGet)
			...
			apps.POST("/:name/manifest/configure", s.requireUnlocked(), s.requireAdmin(), s.handleGinAppManifestConfigure)
			apps.POST("/:name/manifest/dry-run", s.requireUnlocked(), s.requireAdmin(), s.handleGinAppManifestDryRun)
			apps.POST("/:name/manifest/update", s.requireUnlocked(), s.requireAdmin(), s.handleGinAppManifestUpdate)
			apps.POST("/:name/config/dry-run", s.requireUnlocked(), s.requireAdmin(), s.handleGinAppConfigDryRun)
			apps.POST("/:name/config/apply", s.requireUnlocked(), s.requireAdmin(), s.handleGinAppConfigApply)
			...
			apps.POST("/:name/transition/access-repair", s.requireUnlocked(), s.requireAdmin(), s.handleGinAppTransitionAccessRepair)
			apps.POST("/:name/transition/finish-cleanup", s.requireUnlocked(), s.requireAdmin(), s.handleGinAppTransitionFinishCleanup)
			apps.POST("/:name/transition/metadata-retry", s.requireUnlocked(), s.requireAdmin(), s.handleGinAppTransitionMetadataRetry)
